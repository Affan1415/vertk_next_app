    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
                <h1 className="text-4xl font-bold text-black underline">
        ...
        >
            {arr.map((_, i) => (
                <motion.div
                    ...
                    className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 bg-neutral-900 dark:bg-black w-full h-4"
                ></motion.div>
            ))}
        </motion.div>
    );
